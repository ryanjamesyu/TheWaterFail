<?php
    ...
    $sql = "SELECT Building, Location, Description, ID, Imagelink, Reviewed FROM Fountains WHERE Building = '$building'";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Water Fountains in <?php echo $building ?></title>
</head>
...
<body>
    ...
    <section>
        <h1>Fountains in <?php echo $building ?></h1>
        <!-- TABLE CONSTRUCTION -->
        <table>
            <tr>
                <th></th>
