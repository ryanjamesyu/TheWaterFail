...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <?php
        ...
        $imagelink = $_REQUEST['imageurl'];

        // $sql = "INSERT INTO Fountains (Building, Description, Location, Username, Imagelink)
        //     VALUES ('$building' , '$description' , '$location' , '$username', $imagelink);";
        ...
        if ($sql = $conn->prepare("INSERT INTO Fountains (Building, Description, Location, Username, Imagelink) VALUES (?, ?, ?, ?, ?)")){
            $sql->bind_param('sssss', $building, $description, $location, $username, $imagelink);
            $sql->execute();
